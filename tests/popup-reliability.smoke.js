...
function buildBackgroundHarness() {
  ...
  const snippet = [
    ...
    extractFunction(backgroundSource, 'sanitizePopupWindowBounds'),
    extractFunction(backgroundSource, 'hasPopupWindowBounds'),
    extractFunction(backgroundSource, 'arePopupWindowBoundsEqual'),
    extractFunction(backgroundSource, 'getPopupWindowUpdateOptions'),
    extractFunction(backgroundSource, 'isPopupWindowBoundsErrorMessage'),
    extractFunction(backgroundSource, 'waitForPopupWindowStabilize'),
  ...
  return { context, calls, updates, overlayCalls };
}
